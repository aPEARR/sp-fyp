...
<title>display pending list</title>
</head>
...
%>
	...
	<br><br>
		...
		<form action="searchpending.jsp" method="get">
		Search pending email: <input type="text" name="searchString"
...
<%
	...
	try {
		...
		//sql
		String sqlStr = "select * from pending";
		...
		while (rs.next()){
			...
			<td>
			<form action="pendingdelete.jsp">
				<input type="hidden" value="<%=id%>" name="hiddenID"> 
				<input type="submit" value="Delete">
			</form>
			<form action="updatepending.jsp">
				<input type="hidden" value="<%=id%>" name="hiddenID">
			...
			<td> 
			<form action="pendingtogranted.jsp">
			<input type="hidden" value="<%=id%>" name="hiddenID">
				<input type="submit" value="Add pending to granted">
			</form>
			</td>
