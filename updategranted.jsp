...
%>
 ...
 <%
	...
	String sqlStr = "select * from granted WHERE id = ?";
...
%>
	<div id="updating">
	<form action="updateGrantedProcess.jsp" method="get">
	<table>
	<tr>
	...
	<div id="updateback">
	<form action="updateGrantedProcess.jsp" method="post">
